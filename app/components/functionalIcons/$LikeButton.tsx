...
export const LikeButton = ({ postId }: Props) => {
    ...
    return (
        <button
            ...
            onClick={handleLike}
            aria-label="いいね！"
            class="group relative -ml-1 inline-flex cursor-pointer items-center justify-center text-gray-600 transition hover:text-red-500 dark:text-gray-400 dark:hover:text-red-500"
        >
            <HeartIcon />
            <span
